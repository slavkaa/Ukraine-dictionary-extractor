...
trait HtmlAdjectiveTrait {
     ...
     */
    public function firstOrNewAdjective($word, $kind, $number, $genus, $dictionaryId)
    {
        $this-> firstOrNewPrykmetnyk($word, $kind, $number, $genus, $dictionaryId);
    }
