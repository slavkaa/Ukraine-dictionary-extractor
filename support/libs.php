...
$accentedLetters =        ['а́','и́','о́','і́','́у́','е́','ї́','є́','Є́','у́','А́','я́','І́','ю́','Ю́','Е́','́й','́м','́н','́ф','́з','́к','́л'
    ,'́ц','́г','́ґ','́ш','́щ','́х','́в','́п','́р','́д','́ж','́ч','́с','́т','́б','́Й','́М','́Н','́Ф','́З','́К','́Л','́'
    ,'́Ц','́Г','́Ґ','́Ш','́Щ','́Х','́В','́П','́Р','́Д','́Ж','́Ч','́С','́Т','́Б','́Я','́я','́Ї','́ї','́У','́у','́І','́і','́А','́а','́О','́о','́Є','́є','́И','́и','́Ю','́ю'];
$accentedLettersReplace = ['а' ,'и' ,'о' ,'і' ,'у'  ,'е' ,'ї' ,'є' ,'Є' ,'у' ,'А' ,'я' ,'І' ,'ю', 'Ю', 'Е́','й', 'м', 'н', 'ф', 'з', 'к', 'л'
    ,'ц' ,'г' ,'ґ' ,'ш' ,'щ' ,'х' ,'в' ,'п' ,'р' ,'д' ,'ж' ,'ч' ,'с' ,'т' ,'б' ,'Й', 'М', 'Н', 'Ф', 'З', 'К', 'Л', ''
    ,'Ц' ,'Г' ,'Ґ' ,'Ш' ,'Щ' ,'Х' ,'В' ,'П' ,'Р' ,'Д' ,'Ж' ,'Ч' ,'С' ,'Т' ,'Б' ,'Я' ,'я' ,'Ї' ,'ї' ,'У' ,'у' ,'І' ,'і' ,'А' ,'а' ,'О' ,'о' ,'Є' ,'є' ,'И' ,'и' ,'Ю' ,'ю' ];
