...
// @acton: php detect_wrong_words.php > wrong_words_if.txt
...
foreach ($titles as $title) {
    ...
    foreach ($textWords as $textWord) {
        ...
        if (array_in_string($foreignLettersWithoutI, $textWord)) {
//            $wrongWords[$title][] = $textWord;
//            echo 'f';
        }

        if (array_in_string(['i','I'], $textWord)) {
            $wrongWords[$title][] = $textWord;
            echo '+';
        }
    }
